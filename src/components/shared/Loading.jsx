      ...
      <div className="store-container">
        <div className="border-animation">
          ...
          >
            ...
            <use className="box" xlinkHref="#box" x="20" y="30"></use>
            <use
              className="parachute"
              xlinkHref="#parachute"
              x="20"
            ...
            <use className="tshirt" xlinkHref="#tshirt"></use>
            <use className="cap" xlinkHref="#cap" y="-150"></use>
            <use className="ball" xlinkHref="#ball" y="-140"></use>
            <use
              className="sky-circle"
              xlinkHref="#sky-circle"
              x="-10px"
              y="5"
            ></use>
            <use
              className="sky-circle2"
              xlinkHref="#sky-circle"
              x="500px"
              y="-125"
            ></use>
            <use
              className="sky-circle3"
              xlinkHref="#sky-circle"
              x="1000px"
              y="50"
            ></use>
            <use className="cloud" xlinkHref="#cloud2" x="0" y="10"></use>
            <use className="plane" xlinkHref="#plane" y="-80"></use>

            <use className="cloud2" xlinkHref="#cloud" x="0" y="130"></use>
            <use className="trees" xlinkHref="#tree" x="40" y="0"></use>
            <circle
              ...
              r="23"
            ></circle>
            <use className="cat" xlinkHref="#cat" x="15" y="5"></use>
            <g id="browser">
              <path
                fill="none"
                className="stroke"
            ...
            <g id="toldo">
              ...
              />
              <use className="tol" xlinkHref="#tol" x="-250"></use>
              <use className="tol" xlinkHref="#tol" x="334"></use>
              <use className="tol" xlinkHref="#tol" x="417"></use>
              <line
                className="stroke round-end"
                x1="277"
                y1="470.5"
            ...
            <use className="grass" xlinkHref="#grass" x="130" y="0"></use>
            <rect
              className="grass"
              x="130"
              y="850"
